...
class Storage:
    ...
    fulllevel.stor.PreviewStor      # for preview of photoalbum/manga
    ...
    def clear_preview_storage(self):
...
class FullscreenGUI(WindowGUI):
    ...
    def enter_full(self):
        ...
        self.stor.PreviewStor = [None] * len(window.fullfilelist)  # clear cache of preview
...
storage support photo album/manga preview
