...
def get_html(input_url, cookie_name, cookie_value):
    ...
    export_html(html_text)
    
def export_html(html_text):
    output_path = os.path.join(to_dir,"yahoo_finance.txt")
...
input_url = r"https://finance.yahoo.com/portfolio/pf_1/view/v1"
cookie_name = "AS"                               # find existing cookies in chrome
cookie_value = "v=1&s=lKdsvtD5&t=1665746446"
