...
matplotlib.use('Agg')
outputPath_name = "C:/Users/neiii/Dropbox/VCP/Screen_data/"          # For placing your newly created pdf   .py所產生全部.pdf將會進入此folder
pythonPath_name = 'C:/Users/neiii/Dropbox/VCP/Screen_data/python'    # For locating this .py and the list of tickers(companylist.csv)   你放置python及companylist.csv既地方
total_info_name = "C:/Users/neiii/Dropbox/VCP/Screen_data/total_info.csv"    # For logging the stock statistic daily  收集每日.pdf數據作縱貫分析
